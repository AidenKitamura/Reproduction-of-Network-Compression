...
from models.mobilenetv2_2 import MobileNetV2
...
CURRENT_SETTING = "mobilenetV2_block_3rdlayer_no_pruning"
...
if __name__ == '__main__':
    ...
    for pruning_rate in PRUNING_RATES:
        ...
        for epoch in range(100):
            ...
            torch.save(result, f'ckpts/{pruning_rate}__2__{CURRENT_SETTING}.pth')
            scheduler.step()
